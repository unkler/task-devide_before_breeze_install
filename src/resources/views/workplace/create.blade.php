...
@section('title', '作業場所登録 | ' . config('app.name'))
  ...
  <div class="mx-4 mt-5">
    <div class="w-full mb-2 rounded-lg shadow-xs dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
      <div class="flex flex-wrap">
        <form method="POST" action="{{ route('workplace.store') }}" class="w-full h-adr">
          @csrf
          ...
          <div class="md:w-4/5 mx-auto p-2">
            ...
            <input type="text" id="name" name="name" value="{{ old('name') }}" maxlength="8"
